...
library(rvdat)
#> 
#> Attaching package: 'rvdat'
#> The following objects are masked from 'package:matos':
#> 
...
#>   project                  file_type upload_date                   file_name
#> 3     161 Tag Detections - .vfl file  2023-10-12 VR2AR_546323_20231012_1.vrl
#> 5     161 Tag Detections - .vfl file  2023-09-13 VR2AR_547715_20230912_1.vrl
#> 6     161 Tag Detections - .vfl file  2023-09-13 VR2AR_547714_20230912_1.vrl
#> 7     161 Tag Detections - .vfl file  2023-09-13 VR2AR_546476_20230912_1.vrl
#> 8     161 Tag Detections - .vfl file  2023-09-13 VR2AR_546470_20230912_1.vrl
#> 9     161 Tag Detections - .vfl file  2023-09-13 VR2AR_546462_20230912_1.vrl
#>                                                       url
...
#> ── Downloading files ────────────────────────────────────────────────────────────
#> ✔ File(s) saved to:
#>    C:\Users\darpa2\AppData\Local\Temp\RtmpIRlnv2\VR2AR_546323_20231012_1.vrl
#> [1] "C:\\Users\\darpa2\\AppData\\Local\\Temp\\RtmpIRlnv2\\VR2AR_546323_20231012_1.vrl"
...
#>   C:\Users\darpa2\AppData\Local\Temp\RtmpIRlnv2/VR2AR_546323_20231012_1.vrl
#> ℹ Files saved in:
#>   C:\Users\darpa2\AppData\Local\Temp\RtmpIRlnv2/VR2AR_546323_20231012_1.csv-fathom-split
```
...
#> 2      TEMP_DESC   Device Time (UTC)                               Time
#> 3           TEMP 2022-05-04 16:00:00                                   
#> 4           TEMP 2022-05-04 17:00:00                                   
#> 5           TEMP 2022-05-04 18:00:00                                   
#>                V4                  V5       V6            V7              V8
#> 1                                                                           
#> 2 Time Offset (h) Time Correction (s)    Model Serial Number Ambient (deg C)
...
head(bwt)
#>   TEMP_DESC   Device.Time..UTC. Time Time.Offset..h. Time.Correction..s.
...
#>      Model Serial.Number Ambient..deg.C. Internal..deg.C.
...
names(bwt)
#> [1] "tempdesc"        "devicetimeutc"   "time"            "timeoffseth"    
#> [5] "timecorrections" "model"           "serialnumber"    "ambientdegc"    
#> [9] "internaldegc"
...
head(bwt)
#>   tempdesc       devicetimeutc time timeoffseth timecorrections    model
#> 1     TEMP 2022-05-04 16:00:00   NA          NA              NA VR2AR-69
#> 2     TEMP 2022-05-04 17:00:00   NA          NA              NA VR2AR-69
#> 3     TEMP 2022-05-04 18:00:00   NA          NA              NA VR2AR-69
#> 4     TEMP 2022-05-04 19:00:00   NA          NA              NA VR2AR-69
#> 5     TEMP 2022-05-04 20:00:00   NA          NA              NA VR2AR-69
#> 6     TEMP 2022-05-04 21:00:00   NA          NA              NA VR2AR-69
#>   serialnumber ambientdegc internaldegc
#> 1       546323      13.558           NA
#> 2       546323      12.869           NA
#> 3       546323      12.827           NA
#> 4       546323      12.806           NA
...
#> 1     DET 2022-05-04 15:28:58   NA          NA              NA VR2AR-69
#> 2     DET 2022-05-04 15:39:32   NA          NA              NA VR2AR-69
#> 3     DET 2022-05-04 15:49:37   NA          NA              NA VR2AR-69
#> 4     DET 2022-05-04 16:09:11   NA          NA              NA VR2AR-69
#> 5     DET 2022-05-04 16:18:23   NA          NA              NA VR2AR-69
#> 6     DET 2022-05-04 16:27:44   NA          NA              NA VR2AR-69
#>   serialnumber channel detectiontype         fullid    id rawdata
#> 1       546323       1           PPM A69-1601-60787 60787      NA
#> 2       546323       1           PPM A69-1601-60787 60787      NA
#> 3       546323       1           PPM A69-1601-60787 60787      NA
#> 4       546323       1           PPM A69-1601-60787 60787      NA
#> 5       546323       1           PPM A69-1601-60787 60787      NA
#> 6       546323       1           PPM A69-1601-60787 60787      NA
#>   transmitterserial signalstrengthdb noisedb gaindb qualityscore stationname
#> 1                NA               NA      NA     NA           NA          NA
#> 2                NA               NA      NA     NA           NA          NA
#> 3                NA               NA      NA     NA           NA          NA
#> 4                NA               NA      NA     NA           NA          NA
