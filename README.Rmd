...
Extract and run the installer, paying attention into which directory the program is installed. On my (Windows) machine, it installs itself into `C:\Program Files\Innovasea\Fathom`.
...
download.file(
  URLencode(
    file.path(
      ...
      "detection_files_raw/HR2-180 461396 2021-04-20 173145.vdat"
    )
  ),
  destfile = file.path(
    td,
...
list.files(file.path(td, "HR2-180 461396 2021-04-20 173145.csv-fathom-split"))
```
