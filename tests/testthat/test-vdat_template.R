...
test_that("correct types", {
  ...
  expect_named(
    template,
    c(
      "ATTITUDE_DESC", "BATTERY_DESC", "CFG_CHANNEL_DESC", "CFG_RECEIVER_HR3_DESC",
      ...
      "DIAG_VR4_DESC", "DIAG_NEXTRAK_DESC", "EVENT_DESC", "EVENT_FAULT_DESC",
      "EVENT_INIT_DESC", "EVENT_OFFLOAD_DESC", "HEALTH_HR2_DESC", "HEALTH_HR3_DESC",
      "HEALTH_VR2AR_DESC", "HEALTH_VR2TX_DESC", "HEALTH_VR2W_DESC", "HEALTH_VR4_DESC",
      "HEALTH_NEXTRAK_DESC", "NOISE_STATS_VR2AR_DESC", "NOISE_STATS_VR2TX_DESC",
      "PING_DESC", "TEMP_DESC", "TEMP_STATS_DESC"
    )
  )
})
